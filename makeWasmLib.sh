...
$WASI_CLANG --sysroot $WASI_SYSROOT $LDFLAGS $SB_WRAPPER $1 -o $ROOT/test/lib$CFILENAME.wasm
...
gcc -shared -fPIC -O3 -o $ROOT/test/libWasm$CFILENAME.so $ROOT/test/libWasm$CFILENAME.c build/_deps/mod_wasm2c-src/wasm2c/wasm-rt-impl.c build/_deps/mod_wasm2c-src/wasm2c/wasm-rt-os-unix.c build/_deps/mod_wasm2c-src/wasm2c/wasm-rt-os-win.c build/_deps/mod_wasm2c-src/wasm2c/wasm-rt-wasi.c
